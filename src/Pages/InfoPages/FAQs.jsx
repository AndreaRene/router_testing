const FAQs = () => {
    return (
        <section style={{ width: '40%', margin: 'auto', marginTop: '5rem' }}>
            ...
            <p>We wanted a digital tool that could house multiple decks, provide insightful spread information, and offer on-demand readings without the need to lug around a heavy bag of decks and books. This app is our answer to that need—a portable tarot companion for both novices and experienced users alike, empowering you to explore the depths of tarot wherever you go.</p>
