        ...
        <div style={ { display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' } }>
            <section style={ { width: '30%', textAlign: 'center' } }>
                ...
                <div style={ fieldContainerStyle }>
                    ...
                    <input type="text" id="contactName" style={ inputStyle } />
                </div>
                <div style={ fieldContainerStyle }>
                    <label htmlFor="contactEmail" style={ labelStyle }>Email:</label>
                    <input type="email" id="contactEmail" style={ inputStyle } />
                </div>
                <div style={ fieldContainerStyle }>
                    <label htmlFor="contactMessage" style={ labelStyle }>Message:</label>
                    <textarea id="contactMessage" style={ { ...inputStyle, height: '100px' } } />
                </div>
                <div style={ { textAlign: 'center', marginTop: '30px' } }>
                    <button style={ { backgroundColor: 'lightgrey', color: 'darkslategrey', padding: '10px 15px', border: 'none', borderRadius: '4px',marginTop: '3rem' } }>
                        Send Message
                    </button>
                </div>
